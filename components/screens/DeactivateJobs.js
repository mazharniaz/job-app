...
export default class DeactivateJobs extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    _retrieveData = async () => {
        ...
        try {
          ...
          axios.get(`http://production.myquickshift.com/app_api/decline_jobs_api/${this.state.user_id}`)
          .then((response) => {
      ...
      list = () => {
        return this.state.data.decline_jobs.map((element, i) => {
          return (
